local colors = {
        black = { '#17191e', '#0e1013' , '#151820' , '#0c0e15' , '#191a1c' , '#101012' },
          bg0 = { '#21242b', '#1f2329' , '#242b38' , '#1a212e' , '#2c2d30' , '#232326' },
          bg1 = { '#2C3039', '#282c34' , '#2d3343' , '#21283b' , '#35373b' , '#2c2d31' },
          bg2 = { '#373C48', '#30363f' , '#343e4f' , '#283347' , '#3e4045' , '#35363b' },
          bg3 = { '#424856', '#323641' , '#363c51' , '#2a324a' , '#404247' , '#37383d' },
         bg_d = { '#181b20', '#181b20' , '#1e242e' , '#141b24' , '#242628' , '#1b1c1e' },
